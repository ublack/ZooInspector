...
public class ZooInspectorNodeViewersPanel extends JPanel implements
    ...
    private final List<ZooInspectorNodeViewer> nodeViewers = new ArrayList<ZooInspectorNodeViewer>();
     ...
     */
    public ZooInspectorNodeViewersPanel(ZooInspectorNodeManager zooInspectorManager, List<ZooInspectorNodeViewer> nodeViewers) {
